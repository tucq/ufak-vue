    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="状态">
          <a-row>
            <a-col :span="12"><a-switch checkedChildren="启用" unCheckedChildren="停用" :checked="state == '0' ? true : false" @click="e => handelCheck(e)"/></a-col>
            <a-col :span="8" push="6"><a-button @click="refProduct" type="primary" icon="plus">关联商品</a-button></a-col>
            <a-col :span="4" push="4">
