        ...
        <a-row :gutter="20">
          ...
          <a-col :span="12">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="上下架">
              <j-dict-select-tag v-decorator="['state', validatorRules.state]" :triggerChange="true"
                                 placeholder="请选择上下架" dictCode="product_state"/>
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="20">
          ...
          <a-col :span="12">
            <a-form-item
              ...
              :wrapperCol="wrapperCol"
              label="运费">
              <a-input placeholder="免运费请输0" v-decorator="['freightAmount', validatorRules.freightAmount]"
                       maxlength="200"/>
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <a-row :gutter="20" style="margin-left: 10px;margin-right: 10px">
          <a-tabs defaultActiveKey="1">
            ...
            <a-tab-pane key="2">
              ...
              <product-detail-images ref="productDetailImages" :headers="headers" @beforeUpload="beforeUpload"
            ...
            <a-tab-pane key="3">
              ...
              <product-specs ref="productSpecs" @dataOne="handelDataOne" @dataTwo="handelDataTwo"
                             ...
                             @removeProductSpecsList="handelRemoveSpecsList"
